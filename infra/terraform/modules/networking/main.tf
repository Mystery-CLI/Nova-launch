...
# Module: networking
#
# Creates the VPC, public/private subnets across two AZs, Internet Gateway,
# NAT Gateways, and route tables for the Nova Launch platform.
#
# Design decisions:
#   - Two AZs for high availability
#   - Public subnets: ALB, NAT Gateways
#   - Private subnets: ECS tasks, RDS, ElastiCache
#   - One NAT Gateway per AZ to avoid cross-AZ traffic costs in production
#     (single NAT in staging to reduce cost)
##############################################################################
...
resource "aws_eip" "nat" {
  # Use one NAT per AZ in production; single NAT in staging to save cost
...
# ---------------------------------------------------------------------------
# Route Tables — Private (one per AZ when multi-NAT, shared when single-NAT)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# VPC Flow Logs (security best practice — log all traffic)
# ---------------------------------------------------------------------------
